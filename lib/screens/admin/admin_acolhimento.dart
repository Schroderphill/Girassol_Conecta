...
class AdmAcolhimentoScreen extends StatefulWidget {
  const AdmAcolhimentoScreen({super.key});

  @override
  State<AdmAcolhimentoScreen> createState() => _AdmAcolhimentoScreenState();
}

class _AdmAcolhimentoScreenState extends State<AdmAcolhimentoScreen> {
  ...
  // NORMAL LOAD (Agora com filtro 'Agendado' por padrão)
  Future<void> _carregarAgendas() async {
    // ALTERADO: Define o filtro inicial como 'Agendado'.
    return _carregarAgendasComFiltro('Agendado'); 
  }
  ...
  Future<void> _finalizarAcolhimento(String idAtendimento) async {
    await _acolhimentoController.abrirFimAcolhimentoModal(context, idAtendimento);
  ...
  Widget build(BuildContext context) {
    // ... (restante do código build não alterado)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Realizar Acolhimentos'),
        actions: [
          IconButton(
            ...
            children: [
              ...
              TextField(
                decoration: const InputDecoration(
                  labelText: 'Pesquisar por usuário',
                  ...
                  child: Column(
                    children: [
                      ...
                      Column(
                        ...
                        children: const [
                          // PRIMEIRA LINHA: Familiar e Socioeconômico
                          Row(
                            children: [
                              Icon(Icons.group_add, size: 20, color: Colors.blue),
                              SizedBox(width: 4),
                              Text('Adiciona Familiar.',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold, fontSize: 13)),
                              SizedBox(width: 12),
                              Icon(Icons.attach_money, size: 20, color: Colors.blue),
                              SizedBox(width: 4),
                              Text('Adiciona Socioeconômico.',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold, fontSize: 13)),
                            ],
                          ),
                          
                          // NOVO: Adiciona um espaçamento vertical entre as linhas
                          SizedBox(height: 8), 

                          // SEGUNDA LINHA: Finalizar
                          Row( // NOVO: Inicia um novo Row para a terceira opção
                            children: [
                              Icon(Icons.check_outlined, size: 20, color: Colors.blue),
                              SizedBox(width: 4),
                              Text('Finalizar Acolhimento.',
                                  style: TextStyle(
                                      fontWeight: FontWeight.bold, fontSize: 13)),
                            ],
                          ),
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      IconButton(
                                                        ...
                                                        onPressed: () => _adicionarNucleoFamiliar(ag),
                                                      ),
                                                      ...
                                                      IconButton(
                                                        ...
                                                        onPressed: () => _adicionarDadosEconomicos(ag),
                                                      ),
                                                      const SizedBox(width: 3),
                                                      ...
                                                      IconButton(
                                                        ...
                                                        onPressed: () => _finalizarAcolhimento(ag['idAtendimento'].toString()),
                                                      ),
                                                    ],
                                                  ),
